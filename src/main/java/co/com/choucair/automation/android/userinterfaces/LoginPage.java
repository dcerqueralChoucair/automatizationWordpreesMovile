...
public class LoginPage {
    ...
    public static final Target PASSWORD_LINK = Target.the("link for enter you password")
    ...
    public static final Target PASSWORD_BUTTON = Target.the("button next password")
            .located(By.id("org.wordpress.android:id/primary_button"));
    public static final Target TEXT_LABEL = Target.the("text label for validation")
